...
# ==============================================================================
# Converts a GFF3 annotation to TRANSCRIPT-coordinate GTF compatible with:
...
INPUT_GFF="${1:-Musa_acuminata_DH_Pahang_v4.gff3}"
OUTPUT_GTF="${2:-Musa_acuminata_DH_Pahang_v4_transcripts.gtf}"
...
FASTA_FILE="$SCRIPT_DIR/../reference_genome/Musa_acuminata_DH_Pahang_v4_transcripts.fa"
