...
# ==============================================================================
# Repairs doubled/escaped quotes in a GTF attribute column, and optionally
# renames sequences from a mapping file.
#
# BANANA TEMPLATE - copied from the eggplant tree. This script takes NO
# arguments: edit INPUT_GTF / OUTPUT_GTF below before running.
#
# Key transformations:
...
INPUT_GTF="Musa_acuminata_DH_Pahang_v4_genome_raw.gtf"   # TODO: set to your input GTF

# Output GTF file (reformatted)
OUTPUT_GTF="Musa_acuminata_DH_Pahang_v4_genome.gtf"      # TODO: confirm output name
