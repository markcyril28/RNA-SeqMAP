...
echo "  • single_project/PRJNA1237608_{selected,test}.csv are subsets of PRJNA1237608.csv"
echo "  • combined_projects/PRJNA1237608_selected_plus_PRJNA606623_PRJNA935075.csv is the"
echo "    union of single_project/PRJNA1237608_selected.csv + combined_projects/PRJNA606623_and_PRJNA935075.csv"
