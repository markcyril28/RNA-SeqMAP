...
FOLDERS=(
    ...
    "${ALIGNMENT_RESULTS_ROOT:-$PROJECT_ROOT/II_RESULTS/2_ALIGNMENT_RESULTs}"
    "${POST_PROCESSING_ROOT:-$PROJECT_ROOT/II_RESULTS/3_POST_PROC/${CURRENT_GENE_GROUP:-_active}}"
    "${CONCORDANCE_OUTPUT_ROOT:-$PROJECT_ROOT/II_RESULTS/4_CONCORDANCE_ANALYSIS}"
    "$PROJECT_ROOT/logs"
