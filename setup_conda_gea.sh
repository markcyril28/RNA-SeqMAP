...
log_info "For standalone viewer setup, see: setup_html_viewer_env.sh"
log_info "  bash setup_html_viewer_env.sh --generate   # generate viewer only"
log_info "  bash setup_html_viewer_env.sh --serve      # serve on localhost:8080"
log_info ""
